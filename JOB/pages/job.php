...
// Fetch job details using a prepared statement
$stmt = $conn->prepare("SELECT title, description, responsibilities, requirements, preferred_qualifications, category, location, created_at, photo, thumbnail FROM jobs WHERE id = ?");
